...
function openLetter() {
    ...
    /*
     * Sedikit efek tambahan supaya love
     * terasa seperti muncul dengan lembut.
     */
...
/* =========================================================
   OPENING HEART EFFECT
   ========================================================= */

function createOpeningHearts() {

    if (!loveCorner) return;
    ...
    if (
        loveCorner.dataset.heartsCreated === "true"
    ) {
        return;
    }
    ...
    const hearts =
        loveCorner.querySelectorAll("span");
...
function playKeyboardSound() {
    ...
    try {
        ...
        /* Audio error tidak menghentikan website */
...
function typeText(
    ...
    function typeNext() {
        ...
        /*
         * Suara keyboard tidak dimainkan
         * setiap huruf supaya tetap ringan.
         */
