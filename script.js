...
function setupNavigation() {
    ...
    if (replyButton) {
        ...
        replyButton.addEventListener("click", () => {
            ...
            /*
             * Pesan yang otomatis dimasukkan
             * ke kolom chat WhatsApp.
             */
...
function openLetter() {
    ...
    /*
     * Unlock keyboard audio
     * melalui interaksi pertama.
     */
    ...
    /*
     * Beri waktu untuk animasi
     * amplop sebelum pindah chapter.
     */
...
function setupKeyboardSound() {
    ...
    /*
     * Jangan biarkan keyboard sound
     * otomatis berjalan saat halaman dibuka.
     */
...
function unlockKeyboardAudio() {
    ...
    /*
     * Unlock audio setelah interaksi user.
     */
...
function goToScene(number) {
    ...
    /*
     * Chapter 7 memiliki typing animation.
     */
...
function typeText(
    ...
    function typeNext() {
        ...
        /*
         * Keyboard sound dimainkan
         * secara berkala agar tetap ringan.
         */
...
document.addEventListener(
    ...
    event => {
        ...
        /*
         * Swipe hanya aktif jika
         * gerakan horizontal cukup jelas.
         */
