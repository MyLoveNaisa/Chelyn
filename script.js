/* =========================================================
   ...
   MUSIC BEHAVIOR:
   - Tidak autoplay saat website dibuka
   - BGM mulai ketika surat/amplop diklik
   - Fade-in dari 0 → 42%
   - Loop terus sampai selesai
   - Tombol MUSIC tetap bisa pause/play
========================================================= */
...
function startMusic() {
    ...
    /*
     * Mulai dari volume 0.
     * Musik kemudian fade-in.
     */
    bgm.volume = 0;

    /*
     * Pastikan audio tidak dalam keadaan
     * paused dari percobaan sebelumnya.
     */
    try {
...
function openEnvelope() {
    ...
    /*
     * Klik surat merupakan user interaction.
     * Jadi browser mobile mengizinkan bgm.play().
     */
    startMusic();
...
document.addEventListener(
    ...
    () => {
        ...
        if (
            ...
            /*
             * Hentikan spawn heart sementara.
             */
            if (gameRunning) {
        ...
        /*
         * Jika musik sebelumnya sedang aktif
         * dan browser membuatnya pause,
         * coba lanjutkan.
         */
        if (
            musicPlaying &&
